...
export const ProductData = [
  ...
  },
  {
    ...
    quantity: "IN STOCK",
    productDetails:
      "33 King size papers made from rice! This product comes with papers, tips and a foldable tray, to save the effort of finding base paper ",
  },
  {
    id: "3",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "50 wide tips per booklet  Chlorine and chemical free tips to roll perfect doobies!",
  },
  {
    id: "4",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "Winner Of The European Product Awards 2011  33 Chlorine free unbleached king size papers + 33 unbleached tips.",
  },
  {
    id: "5",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "the perfect 3 in 1 kit you will ever need! 32 Unbleached papers, unbleached tips and filter that makes sure that nothing goes into the roach while you puff puff pass!",
  },
  {
    id: "6",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "32 ultra thin organic papers per booklet.  Choose from a variety of dope ass packs",
  },

  {
    ...
    quantity: "IN STOCK",
    productDetails:
      "Tobacco-free cones made from hemp.  2 blunts in a reusable pack.",
  },
  {
    id: "8",
    images: [
  ...
  },
  {
    ...
    quantity: "IN STOCK",
    productDetails:
      "50 perforated tips per booklet.  don’t panic, its organic!",
  },
  {
    id: "10",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "32 Premium RAW quality papers with watermark that ensures slow steady burn.",
  },
  {
    id: "11",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "Plant the tip into the soil before/after use to see an amarnath plant grow",
  },
  {
    id: "12",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "40 transparent papers made from cellulose. Its see-through build will make you drool over it!",
  },
  {
    id: "13",
    images: [
    ...
    quantity: "IN STOCK",
    productDetails:
      "RAW-thentic cones for all occasions! 1 x RAW Cone 1 1/4 (84 mm in length) 1 x RAW Cone King Size (109 mm) 1 x RAW Cone Party Size (140 mm) 1 x RAW Emperador (180 mm)  1 x RAW Supernatural (280 mm) Don’t let the party stop!!!!!!!!!!!!!",
  },

  {
    ...
    quantity: "IN STOCK",
    productDetails:
      "Each one is uniquely made with love Use it as keychain or tag it anywhere you want!",
  },
  {
    id: "15",
    images: [
  ...
  },
  {
    ...
    quantity: "IN STOCK",
    productDetails:
      "Handmade resin ashtray made with love  Smoky design, gives sexy vibes. About 10cm in diameter(round)",
  },
